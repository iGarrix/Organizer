		...
		<form onSubmit={handleSubmit(onSubmit)} className="flex flex-col xs:px-2 lg:px-0">
			<div className="grid grid-cols-[1fr_22rem] gap-x-4 xs:grid-cols-1 lg:grid-cols-[1fr_22rem]">
				<div className="flex flex-col relative">
					...
					<br />
					<div className="flex gap-2 pb-[10rem] xs:pb-4 lg:pb-[10rem] xs:flex-col sm:flex-row">
						<DefButton type="submit" className="bg-sky-500 text-white hover:bg-sky-600">
							{isSubmitSuccessful ? "Task created" : "Create task"}
						</DefButton>
						<DefButton
							type="submit"
				...
				<div className="relative xs:row-start-2 lg:row-start-1 lg:col-start-2">
...
const c = observer(NewTaskPage)
export { c as CNewTaskPage }
