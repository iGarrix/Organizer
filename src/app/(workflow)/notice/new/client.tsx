		...
		<form onSubmit={handleSubmit(onSubmit)} className="flex flex-col xs:px-2 lg:px-0">
			<div className="grid gap-x-4">
				<div className="flex flex-col">
					<div className="sticky top-[4rem] xs:top-0 md:top-[4rem] pb-2 z-50 bg-light dark:bg-dark-200">
					...
					<br />
					<div className="flex gap-2 pb-[10rem] xs:pb-0 lg:pb-[10rem] xs:flex-col sm:flex-row">
...
const c = observer(NewNoticePage)
export { c as CNewNoticePage }
