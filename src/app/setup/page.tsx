...
export default function SetupPage() {
	...
	return (
		<div className='w-svw h-svh overflow-x-hidden grid grid-rows-[25svh_1fr] gap-5 pb-[3rem] relative'>
			<div className='flex items-center justify-center gap-5 sticky top-0 left-0 bg-light/70 backdrop-blur-sm z-10 px-[2rem]'>
			...
			<div className='flex flex-col items-center justify-start'>
				...
				{progresPage.way === 'scratch' && (
					<ScratchSetupWay
						setProgresPage={setProgresPage}
						progresPage={progresPage}
					/>
				)}
				<AnimatePresence>
